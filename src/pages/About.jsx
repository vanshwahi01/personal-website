  ...
  return (
    <div className="about-container">
      ...
      <div className="education-section">
        ...
        <div className="roadmap">
          <div className="roadmap-entry">
            <img src="/images/waterloo.jpeg" alt="University Logo" className="school-logo" />
          ...
          <div className="roadmap-entry">
            <img src="/images/tsrs.jpeg" alt="School 1 Logo" className="school-logo" />
            <div className="school-details">
      ...
      <div className="experience-section">
        ...
        <div className="roadmap">
          <div className="roadmap-entry">
            <img src="/images/pcc.jpeg" alt="Company Logo" className="company-logo" />
          ...
          <div className="roadmap-entry">
            <img src="/images/dawson.jpeg" alt="Company Logo" className="company-logo" />
            <div className="experience-details">
          ...
          <div className="roadmap-entry">
            <img src="/images/eon.jpeg" alt="Company Logo" className="company-logo" />
            <div className="experience-details">
